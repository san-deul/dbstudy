...
SELECT STANDARD_HASH('1111', 'SHA256') -- SHA256 암호화방식
     , STANDARD_HASH('1111', 'SHA384') -- SHA384 암호화방식
     , STANDARD_HASH('1111', 'SHA512') -- SHA512 암호화방식
     , STANDARD_HASH('1111', 'MD5')    -- MD5    암호화방식
  FROM DUAL;
  
-- 2. 순위 구하기 (동점자의 경우 같은 순위를 가짐)..진짜 순위
...
-- 3. 행 번호 구하기 (동점자 처리 방식이 없음)..이거많이씀
SELECT EMP_NO, NAME, SALARY
